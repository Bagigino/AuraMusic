const ERROR_MESSAGES: Record<string, string> = {
  ...
  INVALID_MEDIA_FILE: 'Il file M4A scaricato risulta incompleto. Riprova il download.',
  ...
  INVALID_BACKUP_FORMAT: 'Il file selezionato non e un backup AuraMusic.',
  INVALID_BACKUP_FILE: 'Il file selezionato non e un backup leggibile.',
  UNSUPPORTED_BACKUP_VERSION: 'Questa versione del backup non e supportata.',
  CORRUPT_ARCHIVE: 'Il backup e corrotto o incompleto.',
  UNSUPPORTED_ARCHIVE: 'Il formato interno del backup non e supportato.',
  UNSAFE_ARCHIVE_ENTRY: 'Il backup contiene un percorso non sicuro.',
  MISSING_BACKUP_METADATA: 'Nel backup mancano manifest.json o library.json.',
  INVALID_BACKUP_JSON: 'I metadata JSON del backup non sono validi.',
  INVALID_BACKUP_TRACK: 'Il backup contiene una Track non valida.',
  INVALID_BACKUP_PLAYLIST: 'Il backup contiene una playlist non valida.',
  INVALID_BACKUP_MEMBERSHIP: 'Il backup contiene una relazione playlist non valida.',
  BACKUP_COUNT_MISMATCH: 'I conteggi del backup non corrispondono ai dati.',
  BACKUP_SIZE_MISMATCH: 'Le dimensioni dichiarate dal backup non sono coerenti.',
  BACKUP_TOO_LARGE: 'Il backup supera i limiti ZIP supportati.',
  BACKUP_COPY_FAILED: 'La copia temporanea di un brano non e riuscita.',
  ARCHIVE_FAILED: 'Non e stato possibile creare l’archivio finale.',
  UNSAFE_BACKUP_FILE: 'Il backup contiene un elemento filesystem non consentito.',
  UNSAFE_PATH: 'Il backup contiene o usa un percorso non sicuro.',
  MISSING_AUDIO_FILE: 'Nel backup manca almeno un file M4A richiesto.',
  CHECKSUM_MISMATCH: 'Un file M4A del backup e corrotto.',
  BACKUP_FILE_MISMATCH: 'I file del backup non corrispondono ai metadata.',
  RESTORE_SESSION_EXPIRED: 'La sessione di restore e scaduta. Seleziona di nuovo il backup.',
  ROLLBACK_FAILED: 'Il restore e fallito e il rollback automatico richiede attenzione.',
